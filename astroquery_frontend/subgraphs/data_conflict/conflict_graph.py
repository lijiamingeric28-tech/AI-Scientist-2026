...
def _aggregation_node(state: QualityGraphState) -> dict[str, Any]:
    return _wrap("VarianceAggregationAgent", _aggregation.run, "conflict")(state)


def _classification_node(state: QualityGraphState) -> dict[str, Any]:
    return _wrap("DifferenceClassificationAgent", _classification.run, "conflict")(state)


def _verification_node(state: QualityGraphState) -> dict[str, Any]:
    return _wrap("AnomalyVerificationAgent", _verification.run, "conflict")(state)


def _confidence_node(state: QualityGraphState) -> dict[str, Any]:
    return _wrap("AnnotationConfidenceAgent", _confidence.run, "conflict")(state)


def _report_node(state: QualityGraphState) -> dict[str, Any]:
    return _wrap("AnnotationReportAgent", _report.run, "conflict")(state)
