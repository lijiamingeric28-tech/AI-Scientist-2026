...
提取自：subgraph_1-3_v1.0/configs/prompts_extraction.py
"""
...
- source_page: **PDF page number** (sequential page in THIS PDF file, starting from 1)
  IMPORTANT: Use the PDF's internal page number (1, 2, 3...), NOT the journal page number printed on the page footer/header
  Example: if data is on the 5th page of this PDF, use "5", even if the page footer shows "570"
...
- source_page must be pure number (1-indexed PDF page, not journal page)
"""
    return prompt
