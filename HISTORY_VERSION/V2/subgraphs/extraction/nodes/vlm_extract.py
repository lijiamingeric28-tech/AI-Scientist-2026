...
from subgraphs.extraction.tools import pdf_to_images, image_to_base64, call_vlm_api
from config.prompts.extraction import VLM_EXTRACTION_SCHEMA
from config.constants import VLM_CONCURRENCY, VLM_MAX_RETRIES

logger = logging.getLogger(__name__)


def vlm_extract_node(state: ExtractionState) -> ExtractionState:
    logger.info("=" * 80)
    logger.info("[Agent 2] VLM_Extract_Node started")
    logger.info("=" * 80)
