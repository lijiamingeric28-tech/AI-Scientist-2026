"""
Agent 4: Fidelity_Validation_Node
忠实度验证
"""

import logging
from subgraphs.extraction.state import ExtractionState
from subgraphs.extraction.tools import verify_observation
from config.constants import ENTITY_THRESHOLD, PROPERTY_THRESHOLD

logger = logging.getLogger(__name__)


def fidelity_validation_node(state: ExtractionState) -> ExtractionState:
    logger.info("=" * 80)
    logger.info("[Agent 4] Fidelity_Validation_Node started")
    logger.info("=" * 80)
