...
from configs.prompts import SCHEMA_GENERATION_PROMPT
from configs.constants import LOW_TEMP, DEFAULT_TIMEOUT
import logging

logger = logging.getLogger(__name__)


@retry_on_failure(max_attempts=2, timeout=DEFAULT_TIMEOUT)
