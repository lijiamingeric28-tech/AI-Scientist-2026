...
var ScrollAreaViewport = React23.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
      (0, import_jsx_runtime4.jsx)(ScrollAreaViewportStyle, { nonce }),
...
var ScrollAreaViewportStyle = React23.memo(
  ({ nonce }) => {
    return (0, import_jsx_runtime4.jsx)(
      "style",
      {
