"""
normalization_graph.py — Normalization SubGraph (V1 Stub)
...
def _stub_node(state: QualityGraphState) -> dict[str, Any]:
    logger.info("[NormalizationGraph] Stub: pass-through")
    return {"workflow_state": {"route_decision": "Export", "execution_status": "Success",
            "current_node": "normalization_stub",
            "workflow_history": [{"agent": "NormalizationGraph", "stage": "Stub",
