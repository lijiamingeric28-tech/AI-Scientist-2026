...
from tools.extraction import pdf_to_base64_page, call_ocr_api
from configs.constants import OCR_CONCURRENCY, OCR_MAX_RETRIES

logger = logging.getLogger(__name__)


def ocr_extract_agent(state: ExtractionState) -> ExtractionState:
    logger.info("=" * 80)
    logger.info("[Agent 3] OCR_Extract_Agent started")
    logger.info("=" * 80)
