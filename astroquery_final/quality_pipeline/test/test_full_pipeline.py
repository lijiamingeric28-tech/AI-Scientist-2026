...
def scene_1():
    ...
    return {
        ...
        "records": [
            ...
            {"record_id": "W001_Al-7075_yield_strength_0",
             "source_id": "10.1016/j.msea.2024.001", "entity_type": "alloy", "entity_name": "Al-7075",
            ...
            {"record_id": "W001_Al-7075_tensile_strength_0",
             "source_id": "10.1016/j.msea.2024.001", "entity_type": "alloy", "entity_name": "Al-7075",
            ...
            {"record_id": "W002_Al-Zn-Mg-Cu_yield_strength_0",
             "source_id": "10.1007/s11661-023-002", "entity_type": "alloy", "entity_name": "Al-Zn-Mg-Cu",
    ...
    return {
        ...
        "sources": [
            ...
            {"source_id": "10.1016/j.wear.2023.007", "source_type": "paper",
             ...
             "retrieval_priority": 83},
        ],
        "records": [
            # Paper 4: hardness=220,225 HV (同entity, 标准字段, 干净)
            {"record_id": "W004_316L_hardness_0",
             "source_id": "10.1016/j.corsci.2022.004", "entity_type": "alloy", "entity_name": "316L",
             "field_name": "hardness", "field_value": "220", "field_unit": "HV",
             "trace_id": "d1", "provenance": {"page": 3, "bbox": [100, 300, 200, 315]},
             "extraction_method": "llm_table"},
            {"record_id": "W004_316L_hardness_1",
             "source_id": "10.1016/j.corsci.2022.004", "entity_type": "alloy", "entity_name": "316L",
             "field_name": "hardness", "field_value": "225", "field_unit": "HV",
             "trace_id": "d2", "provenance": {"page": 4, "bbox": [100, 300, 200, 315]},
             "extraction_method": "llm_table"},
            # Paper 7: hardness=320,315 HV (同entity='316L', 与Paper4同一材料→冲突)
            {"record_id": "W007_316L_hardness_0",
             "source_id": "10.1016/j.wear.2023.007", "entity_type": "alloy", "entity_name": "316L",
             "field_name": "hardness", "field_value": "320", "field_unit": "HV",
             "trace_id": "g1", "provenance": {"page": 5, "bbox": [90, 400, 250, 415]},
             "extraction_method": "vlm_text"},
            {"record_id": "W007_316L_hardness_1",
             "source_id": "10.1016/j.wear.2023.007", "entity_type": "alloy", "entity_name": "316L",
             "field_name": "hardness", "field_value": "315", "field_unit": "HV",
...
def scene_3():
    ...
    return {
        ...
        "records": [
            {"record_id": "W003_Ti-6Al-4V_yield_strength_0",
             "source_id": "10.1016/j.actamat.2025.003", "entity_type": "alloy", "entity_name": "Ti-6Al-4V",
             "field_name": "yield_strength", "field_value": "880", "field_unit": "MPa",
             "trace_id": "c1", "provenance": {"page": 4, "bbox": [80, 300, 240, 315]},
             "extraction_method": "vlm_text"},
            {"record_id": "W003_Ti-6Al-4V_yield_strength_1",
             "source_id": "10.1016/j.actamat.2025.003", "entity_type": "alloy", "entity_name": "Ti-6Al-4V",
             "field_name": "yield_strength", "field_value": "870", "field_unit": "MPa",
