...
def _build_quality_summary(
    ...
    issues_summary = {
        "assessment_ssues": quality.get("total_issues", 0),
        "normalization_odifications": mods.get("total", 0),
    ...
    risk = {
        "has_human_review_tems": resolution_report.get("metadata", {}).get("human_required", 0) > 0,
