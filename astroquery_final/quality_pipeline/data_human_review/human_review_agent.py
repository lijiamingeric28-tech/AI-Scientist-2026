...
class HumanReviewAgent:
    ...
    def _extract_pending(self, state) -> list[dict]:
        """提取所有待人工审核的冲突/异常 (V3.1: 兼容 resolution_plan.human_review_tems)。"""
        ...
        # 从 resolution_plan.human_review_tems (V3.1 fix: 由 resolution_report_agent 生成)
        plan = resolution_report.get("resolution_plan", {})
        for item in plan.get("human_review_tems", []):
