...
SEM_MAP = {
    ...
    "herbig_haro_object": ["radial_velocity","flux_density","density"],
    "outflow": ["radial_velocity","flux_density","age"],
    "moving_group": ["age","distance","radial_velocity","proper_motion_ra","proper_motion_dec"],
    "yellow_supergiant": ["effective_temperature","luminosity","stellar_radius"],
    ...
    "galaxy_in_pair": ["redshift","distance","radial_velocity"],
    "galaxy_in_group": ["redshift","distance"],
    "galaxy_pair": ["redshift","distance","radial_velocity"],
    "protocluster": ["redshift","stellar_mass","distance"],
    "underdense_region": ["redshift","distance"],
