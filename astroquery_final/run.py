...
用法::
    ...
    python run.py "M31 的距离是多少？"
    python run.py "M31 的金属丰度" --pdf ./my_paper.pdf --pdf ./another.pdf
    python run.py "M31 的距离" -o ./out/result.json
...
def prompt_interactive(preset_pdfs):
    ...
    天体名称/性质的追问由子图 1 在流水线内部完成（节点内 input()）。
    """
    print()
    print("═" * 60)
    print("  AstroQuery AI — 交互模式")
    print("  (直接回车退出；也可用 python run.py \"你的问题\" 跳过本步)")
    print("═" * 60)
