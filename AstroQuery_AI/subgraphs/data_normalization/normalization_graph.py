...
def _source_router_node(state: QualityGraphState) -> dict[str, Any]:
    return _wrap("SourceRouterAgent", _router.run, "normalization")(state)


def _planning_node(state: QualityGraphState) -> dict[str, Any]:
    return _wrap("PlanningAgent", _planning.run, "normalization")(state)


def _normalization_node(state: QualityGraphState) -> dict[str, Any]:
    return _wrap("NormalizationAgent", _normalization.run, "normalization")(state)


def _validation_node(state: QualityGraphState) -> dict[str, Any]:
    return _wrap("ValidationAgent", _validation.run, "normalization")(state)


def _report_node(state: QualityGraphState) -> dict[str, Any]:
    return _wrap("ReportAgent", _report.run, "normalization")(state)
